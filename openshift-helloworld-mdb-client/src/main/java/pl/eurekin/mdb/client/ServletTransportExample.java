...
public class ServletTransportExample
{
   public static void main(final String[] args) throws Exception
   {
      ...
      try
      {
         ...
         env.put(Context.SECURITY_PRINCIPAL, "remote");

         env.put(Context.SECURITY_CREDENTIALS, "remoteJMS");
         ...
         Queue queue = (Queue)initialContext.lookup("jms/queues/replyQueue");
         ...
         connection = cf.createConnection("remote", "remoteJMS");
